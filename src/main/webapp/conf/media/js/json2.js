...
<html lang="en" class=" is-copy-enabled is-u2f-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <link rel="web-socket" href="wss://live.github.com/_sockets/MjA1Mjk4ODg6OTY1ZWE5MzJhMTg3ZGE0ZDU1MzZkMDFlZDZkMWE1N2I6NzIxNWQ0NGFjNDUxNzkzYjQ2OGRlZTYzN2E1Nzk1NWNmMDcwZTc4YmM5YTgwZTE3ZDMyNTcxNjljYjVjYWQ2MQ==--4fb2937b2ddb125528e0e27fda1eb1a93a990652">
    <meta name="pjax-timeout" content="1000">
    <link rel="sudo-modal" href="/sessions/sudo_modal">
    <meta name="request-id" content="7B490019:2CFCF:DC596DD:57C12ECB" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="7B490019:2CFCF:DC596DD:57C12ECB" name="octolytics-dimension-request_id" /><meta content="20529888" name="octolytics-actor-id" /><meta content="shlwsh" name="octolytics-actor-login" /><meta content="749580e9dad5dace3276667cb4977e0813b25f84de12f448ba0ec40af46d8916" name="octolytics-actor-hash" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="shlwsh">

        <meta name="expected-hostname" content="github.com">
      <meta name="js-proxy-site-detection-payload" content="NWE2YjlkY2U3MjFjMWQwMjdjMzQzMGU0MWYzNmZiNTExY2ExOTBmOWUyODhiNDgwODJmMTU2OTcyZmU0MzUxMXx7InJlbW90ZV9hZGRyZXNzIjoiMTIzLjczLjAuMjUiLCJyZXF1ZXN0X2lkIjoiN0I0OTAwMTk6MkNGQ0Y6REM1OTZERDo1N0MxMkVDQiIsInRpbWVzdGFtcCI6MTQ3MjI3ODIyMH0=">


      <link rel="mask-icon" href="https://assets-cdn.github.com/pinned-octocat.svg" color="#4078c0">
      <link rel="icon" type="image/x-icon" href="https://assets-cdn.github.com/favicon.ico">

    <meta name="html-safe-nonce" content="376002671a4ccb99f8a60af3a173f7ae503d0eab">
    <meta content="72226c0f4c956f8948b963c2c960d0b11dc576b1" name="form-nonce" />
...
<a class="dropdown-item" href="/new" data-ga-click="Header, create new repository">
  ...
  <div class="dropdown-header">
    ...
    <a class="dropdown-item" href="/douglascrockford/JSON-js/issues/new" data-ga-click="Header, create new issue">
      New issue
    </a>
  ...
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name tooltipped tooltipped-sw js-menu-target" href="/shlwsh"
       aria-label="View profile and more"
       data-ga-click="Header, show menu, icon:avatar">
      <img alt="@shlwsh" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/20529888?v=3&amp;s=40" width="20" />
      <span class="dropdown-caret"></span>
    </a>
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        <div class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">shlwsh</strong>
        </div>

        <div class="dropdown-divider"></div>

        <a class="dropdown-item" href="/shlwsh" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a>
        ...
        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/logout" class="logout-form" data-form-nonce="72226c0f4c956f8948b963c2c960d0b11dc576b1" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="v+1lOI1n+Q2/qsQx2x/0vuCbKtRLMsgRM2A+MGMhzdYTjLfc+WRLXSHpTawNNJyNTsAmmJ7WaqAk4oTaso5JGw==" /></div>
...
<ul class="pagehead-actions">
  ...
  <li>
        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-form-nonce="72226c0f4c956f8948b963c2c960d0b11dc576b1" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="biz3clhR0JkTj8WgB8YpQlxer1oUB9iF+4+5AkpR9IpKFpgnxlvm/GaImmQbG54FA5Kquu2vBmeuzMsv5TBckg==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="1092277" />
        ...
        <div class="select-menu js-menu-container js-select-menu">
          ...
          <a class="social-count js-social-count"
            ...
            aria-label="494 users are watching this repository">
            494
          </a>
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/unstar" class="starred" data-form-nonce="72226c0f4c956f8948b963c2c960d0b11dc576b1" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="9S9awAefRAm88YGW1v7fAM0IMt5OlEE/nZZpg5Dj1pMD4E8K0dJtIjQkBcqsQDb5aMLEO5Zlhi101jouJEELoQ==" /></div>
      <button
        ...
        <a class="social-count js-social-count" href="/douglascrockford/JSON-js/stargazers"
           aria-label="6320 users starred this repository">
          6,320
        </a>
</form>
    <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/star" class="unstarred" data-form-nonce="72226c0f4c956f8948b963c2c960d0b11dc576b1" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="EZNQXQNjHpj+wYtveK7qj6pCDdXuPkbV7UMOImH4b9JcZU2efnN3ZbRGO42SiYV+PdlVeeFuBp2B4Mx9VukTcQ==" /></div>
      <button
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/fork" class="btn-with-count" data-form-nonce="72226c0f4c956f8948b963c2c960d0b11dc576b1" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="M+3xnZsDzflx/kocXv8gfUSd5yb/euIzelZrp0uz04Yrk6s0/SVKD/pC9klz0PgQlZGnE7pS0bvsZ81A2KjsKg==" /></div>
            <button
                type="submit"
    ...
    <a href="/douglascrockford/JSON-js/network" class="social-count"
       aria-label="3686 users are forked this repository">
      3,686
    </a>
  </li>
</ul>
  ...
  <div class="file-actions">
    ...
    <div class="btn-group">
      ...
      <a href="/douglascrockford/JSON-js/commits/master/json2.js" class="btn btn-sm " rel="nofollow">History</a>
        ...
        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/edit/master/json2.js" class="inline-form js-update-url-with-hash" data-form-nonce="72226c0f4c956f8948b963c2c960d0b11dc576b1" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="lxGm2ATmneTX0EJgxxagP0zFrA9t03i9mnmnByDjna3cn7A4bWA2d5K6vc8xkbDF1WNCIzuCN/NgakKGbNAqrg==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"></path></svg>
          </button>
</form>        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/delete/master/json2.js" class="inline-form" data-form-nonce="72226c0f4c956f8948b963c2c960d0b11dc576b1" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="EnMVn5y53jyJEhznBwASqR0sxmuDBf2b5NJlJIbu+AvNUOrdwxtITFlHihwQ8RbGK3MtsHja9ewjgAfcva8ljg==" /></div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2016 <span title="0.09686s from github-fe121-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
