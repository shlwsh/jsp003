...
<form name="fm001" action="#" method="get">
<input  type="button" id="buttonRefresh" onclick="RefreshData()" name="buttonRefresh" value="刷新"/>
</form>
...
//        t.clear();
        var newData1,newData2 = Array();
        newData1=["1Unity Butler", "Marketing Designer", "San Francisco", "5384", "2009/12/09", "$85,675"];
        newData2=[ "2Martena Mccray", "Post-Sales support", "Edinburgh", "8240", "2011/03/09", "$324,050" ];
        var dataList = new Array();
        dataList.push(newData1);
        dataList.push(newData2);
